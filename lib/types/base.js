...
module.exports = class BaseCheck {
  constructor(prop, path, validator, storeResultIn, displayPath, parentCheck) {
    this.prop = prop
    this.validator = validator
    this.path = path
    this.displayPath = displayPath
    this._targetVarName = storeResultIn
    this._parentCheck = parentCheck || null
    this._loopIndex = parentCheck ? parentCheck._getChildLoopIndex() : 1
  }
