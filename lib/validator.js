...
module.exports = class Validator {
  ...
  build() {
    ...
    const code = this.addCheck(this.root, this.rootPath, this.resultVar())
  ...
  addCheck(prop, path, storeResultIn) {
    const CheckClass = ({
      'array': ArrayType
    , 'boolean': BaseType
    , 'date': BaseType
    ...
    const check = new CheckClass(prop, path, this, storeResultIn)
